...
public class ModifyAutoIncrementStartValueOperationLog implements Writable {
    ...
    public static ModifyAutoIncrementStartValueOperationLog read(DataInput in) throws IOException {
        String json = Text.readString(in);
        return GsonUtils.GSON.fromJson(json, ModifyAutoIncrementStartValueOperationLog.class);
    }
}
